...
CREATE INDEX "idx_user_song_user_arrangement" ON "user_song" USING btree ("user_id","arrangement_id");--> statement-breakpoint
CREATE INDEX "idx_user_song_source_slug" ON "user_song" USING btree ("source_artist_slug","source_slug");